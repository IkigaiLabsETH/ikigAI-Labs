...
A core function of LTL is AI powered workflow automation. This documentation covers key concepts within our workflow platform.
...
- open platform/ltl_platform/schemas/workflow/blocks
...
- open platform/ltl_platform/web/api/workflow/blocks/web/__init__.py
    - import your block
