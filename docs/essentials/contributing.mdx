...
If you're a developer, your skills can be put to great use in improving AgentGPT's codebase. You can contribute by addressing open issues listed on our [GitHub](https://github.com/ltl/AgentGPT), or even by suggesting new features.
...
In the meantime, know that we welcome all individuals, regardless of expertise or background. Feel free to reach out to us on [GitHub](https://github.com/ltl/AgentGPT) or [Discord](https://discord.gg/jdSBAnmdnY).
